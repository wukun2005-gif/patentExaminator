...
| 2026-06-02 | fix(bg-75): "启用知识库"设置失效 — orchestrator 增强函数检查 knowledgeEnabled 配置；客户端传递设置值；UI 关闭时相关项置灰色 | `server/src/lib/orchestrator.ts`、`server/src/routes/agent.ts`、`client/src/agent/AgentClient.ts`、`client/src/features/settings/KnowledgeConfigPanel.tsx`、`client/src/styles/app.css` | 待提交 |
